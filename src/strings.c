...
const u8 gText_Coins[] = _("{VAR_TEXTO_1} Monedas");
...
const u8 gText_DepositedVar2Var1s[] = _("Deposited {VAR_TEXTO_2}\n{VAR_TEXTO_1}.");
...
const u8 gText_PowderQty[] = _("POWDER QTY: {VAR_TEXTO_1}{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NumberItem_HM[] = _("{CLEAR_TO 0x11}{VAR_TEXTO_1}{CLEAR 0x05}{VAR_TEXTO_2}");
...
const u8 gText_Var1IsItThatllBeVar2[] = _("{VAR_TEXTO_1}, is it?\nThat'll be ¥{VAR_TEXTO_2}. Do you want it?");
...
const u8 gText_SpaceForVar1Full[] = _("The space for {VAR_TEXTO_1} is full.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CantSwitchWithAlly[] = _("You can't switch {VAR_TEXTO_1}'s\nPOKéMON with one of yours!{PAUSE_UNTIL_PRESS}");
const u8 gText_EggCantBattle[] = _("An EGG can't battle!{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {VAR_TEXTO_1} POKéMON\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnFrostbiteHealed[] = _("{VAR_TEXTO_1}'s frostbite was healed.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnThawedOut[] = _("{VAR_TEXTO_1} was thawed out.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MovesPPIncreased[] = _("{VAR_TEXTO_1}'s PP increased.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_OkayToDeleteFromRegistry[] = _("Is it okay to delete {VAR_TEXTO_1}\nfrom the REGISTRY?");
...
const u8 gText_DecorationWillBeDiscarded[] = _("This {VAR_TEXTO_1} will be discarded.\nIs that okay?");
...
const u8 gText_WithdrawXItems[] = _("Withdrew {VAR_TEXTO_2}\n{VAR_TEXTO_1}.");
...
const u8 gText_WinsLosses[] = _("W:{COLOR RED}{SHADOW LIGHT_RED}{VAR_TEXTO_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}  L:{COLOR RED}{SHADOW LIGHT_RED}{VAR_TEXTO_2}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}");
...
const u8 gText_NumPokeblocks[] = _("{VAR_TEXTO_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}");
...
const u8 gText_Var1Players[] = _("{VAR_TEXTO_1} PLAYERS");
...
const u8 gText_FloorsCleared[] = _("Floors cleared: {VAR_TEXTO_1}");
...
const u8 gText_XMinYDotZSec[] = _("{VAR_TEXTO_1} min. {VAR_TEXTO_2}.{VAR_TEXTO_3} sec.");
