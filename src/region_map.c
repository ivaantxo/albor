...
static const u16 sRegionMapCursorPal[] = INCBIN_U16("graphics/region_map_afin/cursor.gbapal");
static const u32 sRegionMapCursorSmallGfxLZ[] = INCBIN_U32("graphics/region_map_afin/cursor_small.4bpp.lz");
static const u32 sRegionMapCursorLargeGfxLZ[] = INCBIN_U32("graphics/region_map_afin/cursor_large.4bpp.lz");
static const u16 sRegionMapBg_Pal[] = INCBIN_U16("graphics/mapa_region/hoenn_base.gbapal");
static const u32 sRegionMapBg_GfxLZ[] = INCBIN_U32("graphics/mapa_region/hoenn_affine.8bpp.lz");
static const u32 sRegionMapBg_TilemapLZ[] = INCBIN_U32("graphics/mapa_region/hoenn_affine.tilemap.lz");
static const u16 sRegionMapPlayerIcon_BrendanPal[] = INCBIN_U16("graphics/region_map_afin/brendan_icon.gbapal");
static const u8 sRegionMapPlayerIcon_BrendanGfx[] = INCBIN_U8("graphics/region_map_afin/brendan_icon.4bpp");
static const u16 sRegionMapPlayerIcon_MayPal[] = INCBIN_U16("graphics/region_map_afin/may_icon.gbapal");
static const u8 sRegionMapPlayerIcon_MayGfx[] = INCBIN_U8("graphics/region_map_afin/may_icon.4bpp");
...
{
    [ABNORMAL_WEATHER_ROUTE_114_NORTH - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_114_SOUTH - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_115_WEST  - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_115_EAST  - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_116_NORTH - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_116_SOUTH - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_118_EAST  - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_118_WEST  - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_125_WEST  - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_125_EAST  - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_127_NORTH - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_127_SOUTH - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_129_WEST  - 1] = MAPSEC_NONE,
    [ABNORMAL_WEATHER_ROUTE_129_EAST  - 1] = MAPSEC_NONE
};
...
static const u16 sRegionMapFramePal[] = INCBIN_U16("graphics/region_map_afin/frame.gbapal");
static const u32 sRegionMapFrameGfxLZ[] = INCBIN_U32("graphics/region_map_afin/frame.4bpp.lz");
static const u32 sRegionMapFrameTilemapLZ[] = INCBIN_U32("graphics/region_map_afin/frame.bin.lz");
static const u16 sFlyTargetIcons_Pal[] = INCBIN_U16("graphics/region_map_afin/fly_target_icons.gbapal");
static const u32 sFlyTargetIcons_Gfx[] = INCBIN_U32("graphics/region_map_afin/fly_target_icons.4bpp.lz");
...
void CB2_OpenFlyMap(void)
{
    ...
    case 1:
        ...
        IniciaFondosDesdePlantillas(MODO_1, sFlyMapBgTemplates, ARRAY_COUNT(sFlyMapBgTemplates));
        gMain.state++;
        break;
    case 2:
    ...
    case 7:
        ...
        AddTextPrinterParameterized(WIN_FLY_TO_WHERE, FUENTE_NORMAL, gText_FlyToWhere, 0, 1, 0, NULL);
...
static void DrawFlyDestTextWindow(void)
{
    ...
    if (sFlyMap->regionMap.mapSecType > MAPSECTYPE_NONE && sFlyMap->regionMap.mapSecType < NUM_MAPSEC_TYPES)
    {
        ...
        for (i = 0; i < ARRAY_COUNT(sMultiNameFlyDestinations); i++)
        {
            if (sFlyMap->regionMap.mapSecId == sMultiNameFlyDestinations[i].mapSecId)
            {
                if (FlagGet(sMultiNameFlyDestinations[i].flag))
                {
                    ...
                    AddTextPrinterParameterized(WIN_MAPSEC_NAME_TALL, FUENTE_NORMAL, sFlyMap->regionMap.mapSecName, 0, 1, 0, NULL);
                    name = sMultiNameFlyDestinations[i].name[sFlyMap->regionMap.posWithinMapSec];
                    AddTextPrinterParameterized(WIN_MAPSEC_NAME_TALL, FUENTE_NORMAL, name, GetStringRightAlignXOffset(FUENTE_NORMAL, name, 96), 17, 0, NULL);
                    ProgramaCopiaTilemapVram(FONDO_0);
                    sDrawFlyDestTextWindow = TRUE;
                }
                break;
        ...
        if (!namePrinted)
        {
            ...
            AddTextPrinterParameterized(WIN_MAPSEC_NAME, FUENTE_NORMAL, sFlyMap->regionMap.mapSecName, 0, 1, 0, NULL);
            ProgramaCopiaTilemapVram(FONDO_0);
