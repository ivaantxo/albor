...
static void DrawMatchCallLeftColumnWindows(struct Pokenav_MatchCallGfx *gfx)
{
    ...
    CopyWindowToVram(gfx->locWindowId, COPIA_VENTANA_TILEMAP);
}
...
static void UpdateMatchCallInfoBox(struct Pokenav_MatchCallGfx *gfx)
{
    ...
    CopyWindowToVram(gfx->infoBoxWindowId, COPIA_VENTANA_TILES);
}
...
static void DrawMsgBoxForMatchCallMsg(struct Pokenav_MatchCallGfx *gfx)
{
    ...
    CopyWindowToVram(gfx->msgBoxWindowId, COPIA_VENTANA_COMPLETA);
...
static void LoadCheckPageTrainerPic(struct Pokenav_MatchCallGfx *gfx)
{
    ...
    if (trainerPic >= 0)
    {
        ...
        cursor = RequestDma3Copy(gfx->trainerPicGfx, gfx->trainerPicGfxPtr, sizeof(gfx->trainerPicGfx), DMA_REQUEST_COPY32);
