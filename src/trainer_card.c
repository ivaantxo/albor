...
static void PrintNameOnCardFront(void)
{
    ...
    if (sData->cardType == CARD_TYPE_FRLG)
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 20, 28, sTrainerCardTextColors, TEXT_SKIP_DRAW, buffer);
    else
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 16, 33, sTrainerCardTextColors, TEXT_SKIP_DRAW, buffer);
}
...
static void PrintIdOnCard(void)
{
    ...
    if (sData->cardType == CARD_TYPE_FRLG)
    {
        xPos = GetStringCenterAlignXOffset(FUENTE_NORMAL, buffer, 80) + 132;
        top = 9;
    }
    else
    {
        xPos = GetStringCenterAlignXOffset(FUENTE_NORMAL, buffer, 96) + 120;
        top = 9;
    }

    AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, xPos, top, sTrainerCardTextColors, TEXT_SKIP_DRAW, buffer);
}
...
static void PrintMoneyOnCard(void)
{
    ...
    if (!sData->isHoenn)
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 20, 56, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardMoney);
    else
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 16, 57, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardMoney);
    ...
    if (!sData->isHoenn)
    {
        xOffset = GetStringRightAlignXOffset(FUENTE_NORMAL, gVariableTextoAmpliada, 144);
        top = 56;
    }
    else
    {
        xOffset = GetStringRightAlignXOffset(FUENTE_NORMAL, gVariableTextoAmpliada, 128);
        top = 57;
    }
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, xOffset, top, sTrainerCardTextColors, TEXT_SKIP_DRAW, gVariableTextoAmpliada);
}
...
static void PrintPokedexOnCard(void)
{
    ...
    {
        if (!sData->isHoenn)
            AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 20, 72, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardPokedex);
        else
            AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 16, 73, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardPokedex);
...
static void PrintTimeOnCard(void)
{
    ...
    if (!sData->isHoenn)
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 20, 88, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardTime);
    else
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 16, 89, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardTime);
    ...
    if (minutes > 59)
        minutes = 59;
    width = GetStringWidth(FUENTE_NORMAL, gText_Colon2, 0);
    ...
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, x, y, sTrainerCardTextColors, TEXT_SKIP_DRAW, gVariableTextoAmpliada);
    x += 18;
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, x, y, sTimeColonTextColors[sData->timeColonInvisible], TEXT_SKIP_DRAW, gText_Colon2);
    x += width;
...
{
    if (!sData->isHoenn)
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, 136, 9, sTrainerCardTextColors, TEXT_SKIP_DRAW, sData->textPlayersCard);
    else
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, GetStringRightAlignXOffset(FUENTE_NORMAL, sData->textPlayersCard, 216), 9, sTrainerCardTextColors, TEXT_SKIP_DRAW, sData->textPlayersCard);
}
...
static void PrintStatOnBackOfCard(u8 top, const u8 *statName, u8 *stat, const u8 *color)
{
    ...
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, xOffsets[sData->isHoenn], top * 16 + 33, sTrainerCardTextColors, TEXT_SKIP_DRAW, statName);
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FUENTE_NORMAL, GetStringRightAlignXOffset(FUENTE_NORMAL, stat, widths[sData->isHoenn]), top * 16 + 33, color, TEXT_SKIP_DRAW, stat);
}
