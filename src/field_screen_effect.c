...
static void Task_OrbEffect(u8 taskId)
{
    ...
    case 0:
        ...
        SetBgTilemapPalette(0, 0, 0, TILES_ANCHO_PANTALLA, TILES_ALTURA_PANTALLA, 0xF);
...
static bool32 PrintWhiteOutRecoveryMessage(u8 taskId, const u8 *text, u32 x, u32 y)
{
    ...
    case 0:
        ...
        StringExpandPlaceholders(gVariableTextoAmpliada, text);
        AddTextPrinterParameterized4(windowId, FUENTE_NORMAL, x, y, 1, 0, sWhiteoutTextColors, 1, gVariableTextoAmpliada);
