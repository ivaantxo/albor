...
static const u8 sCondMsg05[] = _("¡{STR_VAR_1} escupe fuego\nvigorosamente!");
...
static const u8 sCondMsg22[] = _("{STR_VAR_1} siente nervios y un\npoco de claustrofobia.");
static const u8 sCondMsg23[] = _("¡{STR_VAR_1} lleva cuidado\npor el poco espacio!");
