...
{//                     Defiende -->
 //  Ataca                 Normal  Lucha   Volador Veneno  Tierra  Roca    Bicho   Fantasma Acero    Fuego   Agua    Planta  Eléctrico Psíquico Hielo   Dragón  Siniestro Hada
    [TIPO_NORMAL]       = {______, ______, ______, ______, ______, X(0.5), ______, X(0.0),  ______,  ______, ______, ______, ______,   ______,  ______, ______, ______,   ______},
    ...
    [TIPO_VENENO]       = {______, ______, ______, X(0.5), X(0.5), X(0.5), X(2.0), X(0.5),  X(0.0),  ______, X(2.0), X(2.0), ______,   ______,  ______, ______, ______,   X(2.0)},
    ...
    [TIPO_ACERO]        = {______, ______, ______, ______, ______, X(2.0), ______, ______,  X(0.5),  ______, X(0.5), ______, X(0.5),   ______,  X(2.0), ______, ______,   X(2.0)},
    ...
    [TIPO_PLANTA]       = {______, ______, X(0.5), X(0.5), X(2.0), X(2.0), X(0.5), X(2.0),  ______,  X(0.5), X(2.0), X(0.5), ______,   ______,  ______, ______, ______,   ______},
    [TIPO_ELECTRICO]    = {______, ______, X(2.0), ______, X(0.0), ______, ______, ______,  X(2.0),  ______, X(2.0), X(0.5), ______,   ______,  ______, X(0.5), ______,   ______},
    ...
    [TIPO_SINIESTRO]    = {______, X(0.5), ______, ______, ______, ______, ______, X(2.0),  ______,  ______, ______, ______, ______,   X(2.0),  ______, ______, ______,   X(0.5)},
    [TIPO_HADA]         = {______, X(2.0), ______, X(0.5), ______, ______, ______, ______,  X(0.5),  X(0.5), ______, X(0.5), ______,   ______,  ______, X(2.0), X(2.0),   ______},
};
