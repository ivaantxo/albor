...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_NATU] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(PAJARO),
        HABILIDADES(SYNCHRONIZE, INSOMNIA, MAGIC_BOUNCE),
        SOMBRA(-1, -4, S),
        NOMBRE(Natu),
        GRITO(NATU),
        POKEDEX(NATU),
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        HABILIDADES(SHARPNESS, ARENA_TRAP, SHEER_FORCE),
        NOMBRE(Trapinch),
        GRITO(TRAPINCH),
        POKEDEX(TRAPINCH),
        SOMBRA(5, -1, S),
    ...
    [SPECIES_TEPIG] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(25)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(AUDAZ, NAVAJAS, BANO_BARRO),
        NOMBRE(Tepig),
        GRITO(TEPIG),
        POKEDEX(TEPIG),
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(25)),
        GRUPO_HUEVO(ANFIBIO),
        HABILIDADES(NONE, NONE, MUTATIPO),
        NOMBRE(Froakie),
        GRITO(FROAKIE),
        POKEDEX(FROAKIE),
