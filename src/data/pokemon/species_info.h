...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        GRUPO_HUEVO(BICHO),
        HABILIDADES(OJO_COMPUESTO, TINTED_LENS, RUN_AWAY),
        NOMBRE(Caterpie),
        GRITO(CATERPIE),
        POKEDEX(CATERPIE),
        SOMBRA(4, 1, S),
    ...
    [SPECIES_METAPOD] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(BICHO),
        HABILIDADES(OJO_COMPUESTO, TINTED_LENS, SHED_SKIN),
        NOMBRE(Metapod),
        GRITO(METAPOD),
        POKEDEX(METAPOD),
        SOMBRA(2, 0, M),
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(BICHO),
        HABILIDADES(OJO_COMPUESTO, TINTED_LENS, ALAS_HIDROFOBAS),
        NOMBRE(Butterfree),
        GRITO(BUTTERFREE),
        POKEDEX(BUTTERFREE),
    ...
    [SPECIES_SENTRET] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(RUN_AWAY, VISTA_LINCE, FRISK),
        SOMBRA(-2, 12, S),
        NOMBRE(Sentret),
        GRITO(SENTRET),
        POKEDEX(SENTRET),
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(PAJARO),
        HABILIDADES(INSOMNIA, VISTA_LINCE, TINTED_LENS),
        SOMBRA(1, 1, S),
        NOMBRE(Hoothoot),
        GRITO(HOOTHOOT),
        POKEDEX(HOOTHOOT),
    ...
    [SPECIES_NINCADA] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(BICHO),
        HABILIDADES(OJO_COMPUESTO, NONE, RUN_AWAY),
        NOMBRE(Nincada),
        GRITO(NINCADA),
        POKEDEX(NINCADA),
        SOMBRA(4, -7, S),
