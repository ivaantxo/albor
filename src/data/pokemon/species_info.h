...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_MACHOP] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(25)),
        GRUPO_HUEVO(HUMANOIDE),
        HABILIDADES(AGALLAS, NO_GUARD, STEADFAST),
        SOMBRA(0, 4, S),
        NOMBRE(Machop),
        GRITO(MACHOP),
        POKEDEX(MACHOP),
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(25)),
        GRUPO_HUEVO(BEBE),
        HABILIDADES(AGALLAS, STEADFAST, VITAL_SPIRIT),
        SOMBRA(1, 3, S),
        NOMBRE(Tyrogue),
        GRITO(TYROGUE),
        POKEDEX(TYROGUE),
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(25)),
        GRUPO_HUEVO(HUMANOIDE),
        HABILIDADES(VISTA_LINCE, IRON_FIST, INNER_FOCUS),
        SOMBRA(0, 10, M),
        NOMBRE(Hitmonchan),
        GRITO(HITMONCHAN),
        POKEDEX(HITMONCHAN),
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        HABILIDADES(INNER_FOCUS, VISTA_LINCE, PICKPOCKET),
        SOMBRA(-1, 5, S),
