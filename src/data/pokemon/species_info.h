...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_EEVEE] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(25)),
        GRUPO_HUEVO(CAMPESTRE),
        HABILIDADES(HUIDIZO, ADAPTABILITY, ANTICIPATION),
        SOMBRA(-1, 1, S),
        NOMBRE(Eevee),
        GRITO(EEVEE),
        POKEDEX(EEVEE),
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(75)),
        GRUPOS_HUEVO(MONSTRUO, PLANTA),
        HABILIDADES(NONE, NONE, LEAF_GUARD),
        SOMBRA(-1, 2, S),
        NOMBRE(Chikorita),
        GRITO(CHIKORITA),
        POKEDEX(CHIKORITA),
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        HABILIDADES(CHLOROPHYLL, LEAF_GUARD, SIGILOSO),
        SOMBRA(-4, 11, S),
        NOMBRE(Hoppip),
        GRITO(HOPPIP),
        POKEDEX(HOPPIP),
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(HUMANOIDE),
        HABILIDADES(ANTICIPATION, DRY_SKIN, STICKY_HOLD),
        NOMBRE(Croagunk),
        GRITO(CROAGUNK),
        POKEDEX(CROAGUNK),
    ...
    [SPECIES_ROOKIDEE] =
    {
        ...
        GENERO(PORCENTAJE_HEMBRA(50)),
        GRUPO_HUEVO(PAJARO),
        HABILIDADES(VISTA_LINCE, UNNERVE, BIG_PECKS),
        NOMBRE(Rookidee),
        GRITO(ROOKIDEE),
        POKEDEX(ROOKIDEE),
