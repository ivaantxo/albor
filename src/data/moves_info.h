...
const struct InfoMovimiento gMovimientos[NUMERO_MOVIMIENTOS] =
{
    ...
    [MOVE_GOLPE_KARATE] =
    {
        ...
        .category = CATEGORIA_FISICA,
        .makesContact = TRUE,
        .battleAnimScript = gBattleAnimMove_GolpeKarate,
    },
    ...
    [MOVE_DOBLE_BOFETON] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ataca 2 veces, cada golpe\n"
            "50% de bajar ataque -1."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TIPO_NORMAL,
        .accuracy = PRECISION_NORMAL,
    ...
    [MOVE_PUNIO_FUEGO] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_PunioFuego,
    },
    ...
    [MOVE_PUNIO_HIELO] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_PunioHielo,
    },
    ...
    [MOVE_PUNIO_TRUENO] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_PunioTrueno,
    },
    ...
    [MOVE_DOBLE_AGUIJON] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_DobleAguijon,
    },
    ...
    [MOVE_BOMBA_SONICA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lanza una bomba sonora\n"
            "que tiene 30% de quemar."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TIPO_DRAGON,
        .accuracy = PRECISION_NORMAL,
    ...
    [MOVE_FURIA_DRAGON] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_FuriaDragon,
    },
    ...
    [MOVE_TELETRANSPORTE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Cambia por compañero con prioridad,\n"
            "manteniendo cambios de estadísticas."),
        .effect = EFECTO_RELEVO,
        .power = 0,
        .type = TIPO_PSIQUICO,
        .accuracy = PRECISION_PERFECTA,
        .pp = PP_MOVIMIENTO_NORMAL,
    ...
    [MOVE_CONSTRICT] = //eliminar?? Quizás Constricción Enrollar o algo así
    {
        .name = COMPOUND_STRING("Constricción"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VIENTO_HELADO] =
    {
        .name = COMPOUND_STRING("Viento helado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_BREATH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lanza su aliento de dragón\n"
            "al rival, con 30% de paralizar."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TIPO_DRAGON,
        .accuracy = PRECISION_NORMAL,
    ...
    [MOVE_OLA_CALOR] =
    {
        .name = COMPOUND_STRING("Ola calor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_BLAST] =
    {
        ...
        PRIORIDAD_NORMAL,
        .category = CATEGORIA_FISICA,
        .balistico = B_UPDATED_MOVE_FLAGS >= GEN_6,
    ...
    [MOVE_ESPACIO_RARO] =
    {
        ...
        .category = CATEGORIA_ESTADO,
        .ignoresProtect = TRUE,
        .battleAnimScript = gBattleAnimMove_EspacioRaro,
    },
    ...
    [MOVE_DANZA_ALETEO] = // Dar a tipos voladores
    {
        .name = COMPOUND_STRING("Danza aleteo"),
        .description = COMPOUND_STRING(
            "Dances to raise Sp. Atk\n"
            "Sp. Def and Speed."),
        .effect = EFECTO_SUBE_ATAQUE_ESPECIAL_VELOCIDAD,
        .power = 0,
        .type = TIPO_BICHO,
        .accuracy = PRECISION_PERFECTA,
        .pp = 20,
    ...
    [MOVE_PICO_ELECTRICO] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_PicoElectrico,
    },
    ...
    [MOVE_BRANQUIBOCADO] =
    {
        ...
        .makesContact = TRUE,
        .bitingMove = TRUE,
        .battleAnimScript = gBattleAnimMove_Branquibocado,
    },
    ...
    [MOVE_TORMENTA_PRIMAVERAL] =
    {
        .name = COMPOUND_STRING("Tormenta primaveral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CORTE_ACUATICO] =
    {
        .name = COMPOUND_STRING("Corte acuático"),
        .description = COMPOUND_STRING(
