...
const u16 gItemIconPalette_ChalecoAsalto[] = INCBIN_U16("graphics/items/icon_palettes/chaleco_asalto.gbapal");
const u16 gItemIconPalette_ChalecoTactico[] = INCBIN_U16("graphics/items/icon_palettes/chaleco_tactico.gbapal");
