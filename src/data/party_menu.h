...
static const u16 sFieldMoves[FIELD_NUMERO_MOVIMIENTOS + 1] =
{
    ...
    [FIELD_MOVE_TELETRANSPORTE]     = MOVE_TELETRANSPORTE,
...
} static const sFieldMoveCursorCallbacks[FIELD_NUMERO_MOVIMIENTOS] =
{
    ...
    [FIELD_MOVE_TELETRANSPORTE]     = {SetUpFieldMove_Teleport,    PARTY_MSG_CANT_USE_HERE},
...
#define ROTOM_FROST_MOVE MOVE_VENTISCA
