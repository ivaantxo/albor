...
static const u8* const sBattleAnims_General[NUM_B_ANIMS_GENERAL] =
{
    ...
    [B_ANIM_ESPACIO_RARO]             = gBattleAnimGeneral_EspacioRaro,
...
void DoMoveAnim(enum Movimientos move)
{
    ...
    if (GetBattlerMoveTargetType(gBattlerAttacker, move) & MOVE_TARGET_FOES_AND_ALLY && EsCombateContraEntrenador(gCombate->tipoCombate))
    {
...
void MoveBattlerSpriteToBG(u8 battlerId, bool8 toBG_2, bool8 setSpriteInvisible)
{
    ...
    if (!toBG_2)
    {
        ...
        RequestDma3Fill(0, (void *)(BG_SCREEN_ADDR(8)), 0x2000, DMA_REQUEST_FILL32);
        RequestDma3Fill(0xFF, (void *)(BG_SCREEN_ADDR(28)), 0x1000, DMA_REQUEST_FILL16);
    ...
    {
        RequestDma3Fill(0, (void *)(BG_SCREEN_ADDR(12)), 0x2000, DMA_REQUEST_FILL32);
        RequestDma3Fill(0, (void *)(BG_SCREEN_ADDR(30)), 0x1000, DMA_REQUEST_FILL32);
...
static void Task_UpdateMonBg(u8 taskId)
{
    ...
    if (!gTasks[taskId].t2_InBg2)
    {
        ...
        CopiaCpu32(&gPlttBufferFaded[OBJ_PLTT_ID(battlerId)], &gPlttBufferFaded[BG_PLTT_ID(animBg.paletteId)], PLTT_SIZE_4BPP);
    }
    else
    {
        gBattle_BG2_X = x + gTasks[taskId].t2_BgX;
        gBattle_BG2_Y = y + gTasks[taskId].t2_BgY;
        CopiaCpu32(&gPlttBufferFaded[OBJ_PLTT_ID(battlerId)], &gPlttBufferFaded[BG_PLTT_ID(9)], PLTT_SIZE_4BPP);
    }
}
