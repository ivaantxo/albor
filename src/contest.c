...
static void InitContestInfoBgs(void)
{
    ...
    IniciaFondosDesdePlantillas(MODO_0, sContestBgTemplates, ARRAY_COUNT(sContestBgTemplates));
...
static void Task_HideMoveSelectScreen(u8 taskId)
{
    ...
    for (i = 0; i < MAX_MON_MOVES; i++)
    {
        ...
        CopyWindowToVram(MOVE_WINDOWS_START + i, COPIA_VENTANA_TILES);
    }
...
static void ContestClearGeneralTextWindow(void)
{
    ...
    CopyWindowToVram(WIN_GENERAL_TEXT, COPIA_VENTANA_TILES);
    Contest_SetBgCopyFlags(0);
}
