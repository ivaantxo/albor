...
static void Task_DoClearSaveDataScreenYesNo(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, FUENTE_NORMAL, gText_ClearAllSaveData, 0, 1, 0, 0);
...
static void Task_ClearSaveDataScreenYesNoChoice(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(0, FUENTE_NORMAL, gText_ClearingData, 0, 1, 0, 0);
...
static bool8 SetupClearSaveDataScreen(void)
{
    ...
    default:
        ...
        IniciaFondosDesdePlantillas(MODO_0, sClearSaveBgTemplates, ARRAY_COUNT(sClearSaveBgTemplates));
