...
void AnimSalpicaTierraDirtRising(struct Sprite *);
static void AnimSalpicaTierraDirtFalling(struct Sprite *);
...
static void SetDigDistorsionFondo(u8, s16, s16);
...
void AnimSalpicaTierraDirt(struct Sprite *sprite)
{
    ...
    else
    {
        ...
        sprite->callback = AnimSalpicaTierraDirtFalling;
    }
}
...
static void AnimSalpicaTierraDirtFalling(struct Sprite *sprite)
{
...
static void AnimTask_DigBounceMovement(u8 taskId)
{
    ...
    case 0:
        ...
        break;
    case 1:
        SetDigDistorsionFondo(task->data[11], task->data[14], task->data[15]);
        task->data[0]++;
        break;
    case 2:
...
static void AnimTask_DigRiseUpFromHole(u8 taskId)
{
    ...
    case 0:
        ...
        break;
    case 1:
        SetDigDistorsionFondo(task->data[11], 0, task->data[15]);
        task->data[0]++;
        break;
    case 2:
...
static void SetDigDistorsionFondo(u8 useBG1, s16 y, s16 endY)
{
    s16 bgX;
    ...
    while (y < endY)
    {
        gRegistrosBuffersDistorsionFondo[0][y] = bgX;
        gRegistrosBuffersDistorsionFondo[1][y] = bgX;
        y++;
    }

    while (y < ALTURA_PANTALLA)
    {
        gRegistrosBuffersDistorsionFondo[0][y] = bgX + ANCHO_PANTALLA;
        gRegistrosBuffersDistorsionFondo[1][y] = bgX + ANCHO_PANTALLA;
        y++;
    }
