...
static void DrawOptionMenuChoice(const u8 *text, u8 x, u8 y, u8 style)
{
    ...
    dst[i] = EOS;
    AddTextPrinterParameterized(WIN_OPTIONS, FUENTE_NORMAL, dst, x, y + 1, TEXT_SKIP_DRAW, NULL);
}
...
static void TextSpeed_DrawChoices(u8 selection)
{
    ...
    widthSlow = GetStringWidth(FUENTE_NORMAL, gText_TextSpeedSlow, 0);
    widthMid = GetStringWidth(FUENTE_NORMAL, gText_TextSpeedMid, 0);
    widthFast = GetStringWidth(FUENTE_NORMAL, gText_TextSpeedFast, 0);

    widthMid -= 94;
    xMid = (widthSlow - widthMid - widthFast) / 2 + 104;
    DrawOptionMenuChoice(gText_TextSpeedMid, xMid, YPOS_TEXTSPEED, styles[1]);

    DrawOptionMenuChoice(gText_TextSpeedFast, GetStringRightAlignXOffset(FUENTE_NORMAL, gText_TextSpeedFast, 198), YPOS_TEXTSPEED, styles[2]);
}
...
static void BattleScene_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleSceneOff, GetStringRightAlignXOffset(FUENTE_NORMAL, gText_BattleSceneOff, 198), YPOS_BATTLESCENE, styles[1]);
}
...
static void Sound_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_SoundStereo, GetStringRightAlignXOffset(FUENTE_NORMAL, gText_SoundStereo, 198), YPOS_SOUND, styles[1]);
}
...
static void ButtonMode_DrawChoices(u8 selection)
{
    ...
    widthNormal = GetStringWidth(FUENTE_NORMAL, gText_ButtonTypeNormal, 0);
    widthLR = GetStringWidth(FUENTE_NORMAL, gText_ButtonTypeLR, 0);
    widthLA = GetStringWidth(FUENTE_NORMAL, gText_ButtonTypeLEqualsA, 0);

    widthLR -= 94;
    xLR = (widthNormal - widthLR - widthLA) / 2 + 104;
    DrawOptionMenuChoice(gText_ButtonTypeLR, xLR, YPOS_BUTTONMODE, styles[1]);

    DrawOptionMenuChoice(gText_ButtonTypeLEqualsA, GetStringRightAlignXOffset(FUENTE_NORMAL, gText_ButtonTypeLEqualsA, 198), YPOS_BUTTONMODE, styles[2]);
}

static void DrawHeaderText(void)
{
    FillWindowPixelBuffer(WIN_HEADER, PIXEL_FILL(1));
    AddTextPrinterParameterized(WIN_HEADER, FUENTE_NORMAL, gText_Option, 8, 1, TEXT_SKIP_DRAW, NULL);
...
static void DrawOptionMenuTexts(void)
{
    ...
    for (i = 0; i < MENUITEM_COUNT; i++)
        AddTextPrinterParameterized(WIN_OPTIONS, FUENTE_NORMAL, sOptionMenuItemsNames[i], 8, (i * 16) + 1, TEXT_SKIP_DRAW, NULL);
    CopyWindowToVram(WIN_OPTIONS, COPYWIN_FULL);
}
