...
static const u8 sText_PkmnHurtByPoison[] = _("¡{B_ATK_NAME_WITH_PREFIX} es herido por el veneno!");
static const u8 sText_PkmnAlreadyPoisoned[] = _("{B_DEF_NAME_WITH_PREFIX} ya está envenenado.");
...
static const u8 sText_PkmnsXMadeYUseless[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} made {B_CURRENT_MOVE} useless!");
...
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fled using its {B_LAST_ITEM}!");
...
static const u8 sText_PkmnSentToPC[] = _("{B_DEF_NAME} was sent to {B_PC_CREATOR_NAME} PC.");
static const u8 sText_Someones[] = _("someone's");
static const u8 sText_Lanettes[] = _("LANETTE's");
static const u8 sText_PkmnDataAddedToDex[] = _("Los datos de {B_DEF_NAME} se añadieron a la Pokédex.");
...
static const u8 sText_PkmnSwitchedStatChanges[] = _("{B_ATK_NAME_WITH_PREFIX} switched stat changes with the target!");
...
const u8 *const gBattleStringsTable[NUMERO_TEXTOS_COMBATE] =
{
    ...
    [STRINGID_PKMNHASNOMOVESLEFT] = COMPOUND_STRING("¡A {B_ATK_NAME_WITH_PREFIX} no le quedan PPs!"),
    ...
    [TEXTO_COMBATE_LANZA_POKEBALL] = COMPOUND_STRING("¡Ahí va la Pokéball!"),
    ...
    [STRINGID_PLAYERDEFEATEDTRAINER] = COMPOUND_STRING("¡Has vencido a {B_TRAINER_CLASS} {B_TRAINER_NAME}!"),
