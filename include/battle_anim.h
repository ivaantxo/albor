...
void DoMoveAnim(enum Movimientos movimiento);
...
u32 CreateInvisibleSpriteCopy(u32 battlerId, u32 spriteId, u32 species);
...
extern const union AffineAnimCmd *const gOrbAffineAnimTable[];
...
extern const union AnimCmd *const gAnims_FuriaDragonFirePlume[];
extern const union AffineAnimCmd *const gAffineAnims_FuriaDragonFire[];
extern const union AnimCmd *const gAnims_FuriaDragonFire[];
