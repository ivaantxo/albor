...
struct BattleStruct
{
    ...
    u8 skyDropTargets[NUMERO_COMBATIENTES]; // For Sky Drop, to account for if multiple Pokemon use Sky Drop in a double battle.
...
struct MonSpritesGfx
{
    ...
    struct SpriteFrameImage frameImages[NUMERO_COMBATIENTES][MAX_MON_PIC_FRAMES];
    u8 *barFontGfx;
    u16 *buffer;
};
