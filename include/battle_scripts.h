...
extern const u8 BattleScript_DiaDePagoMoney[];
extern const u8 ScriptCombate_DerrotaContraSalvajeLegendarios[];
extern const u8 ScriptCombate_DerrotaContraEntrenador[];
...
extern const u8 BattleScript_LeechSeedTurnRecover[];
...
extern const u8 BattleScript_PrintDiaDePagoMoneyString[];
...
extern const u8 ScriptCombate_ActivaLlovizna[];
extern const u8 BattleScript_SpeedBoostActivates[];
extern const u8 BattleScript_TraceActivates[];
extern const u8 ScriptCombate_ActivacionHabilidadCambioObjeto[];
extern const u8 BattleScript_RainDishActivates[];
extern const u8 ScriptCombate_ActivacionDespensa[];
extern const u8 BattleScript_SandstreamActivates[];
extern const u8 BattleScript_ShedSkinActivates[];
extern const u8 ScriptCombate_ActivacionIntimidacionMalAura[];
...
extern const u8 ScriptCombate_ActivaHabilidadCambioTipoDefensivo[];
extern const u8 ScriptCombate_ActivacionHabilidadDanioAtacante[];
...
extern const u8 ScriptCombate_EspacioRaroFin[];
...
extern const u8 BattleScript_TrampasAbsorbidas[];
extern const u8 BattleScript_TrampasBarridas[];
...
extern const u8 ScriptCombate_ActivaHabilidadCambioTipoOfensivo[];
...
extern const u8 ScriptCombate_ActivacionExuvia[];
...
extern const u8 ScriptCombate_TipoTierraNoPuedenSerEchados[];
...
extern const u8 ScriptCombate_EfectoEspacioRaro[];
