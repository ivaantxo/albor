...
enum TextosCombate
{
    TEXTO_COMBATE_INTRO, //hecho
    TEXTO_COMBATE_ENVIAR_POKEMON, //hecho
    STRINGID_RETURNMON,
    STRINGID_SWITCHINMON,
    STRINGID_USEDMOVE,
    STRINGID_TRAINERSLIDE,
    STRINGID_TRAINERLOSETEXT,
    ...
    TEXTO_COMBATE_ATAQUE_FALLO_ATACANTE,
    TEXTO_COMBATE_ATAQUE_FALLO_DEFENSOR,
    TEXTO_COMBATE_PROTECCION,
    STRINGID_STATSWONTINCREASE2,
    TEXTO_COMBATE_TELEPATA,
    ...
    TEXTO_COMBATE_HABILIDAD_PROTEGE_EQUIPO_DE_PRIORIDAD,
