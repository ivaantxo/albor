...
enum TextosBatalla
{
    ...
    TEXTO_BATALLA_ATAQUE_FALLO_ATACANTE,
    TEXTO_BATALLA_ATAQUE_FALLO_DEFENSOR,
    TEXTO_BATALLA_PROTECCION,
    STRINGID_STATSWONTINCREASE2,
    TEXTO_BATALLA_TELEPATA,
    ...
    TEXTO_BATALLA_HABILIDAD_PROTEGE_EQUIPO_DE_PRIORIDAD,
