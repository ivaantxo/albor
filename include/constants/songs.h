...
enum Musica
{
    ...
    SE_RG_CARD_FLIPPING,
    SE_RG_CARD_OPEN,
    SE_RG_BAG_CURSOR, // Usada en máquina de discos
    SE_RG_BAG_POCKET,
    SE_RG_BALL_CLICK,
    SE_RG_SHOP,
    SE_RG_SS_ANNE_HORN,
    ...
    SE_SUDOWOODO_SHAKE,
    SE_DUMMY_1,
    NUMERO_EFECTOS_SONIDO = SE_DUMMY_1,
    MUS_LITTLEROOT_TEST,
    MUS_GSC_ROUTE38,
    MUS_CAUGHT,
    MUS_VICTORY_WILD,
    ...
    MUS_DP_GAME_CORNER,
    MUS_DP_B_TOWER,
    MUS_DP_TV_STATION, // Usada en máquina de discos
    ...
    MUS_DP_ENCOUNTER_CHAMPION, // Usada para Cynthia
    MUS_DP_VS_WILD,
    ...
    MUS_HG_VS_ENTEI,
    MUS_HG_VS_RAIKOU,
    MUS_HG_VS_CHAMPION, // Usada contra Lance
    ...
    MUS_HG_RADIO_VARIETY, // Usada en Pokédex
    MUS_HG_VS_KYOGRE_GROUDON,
    MUS_HG_POKEWALKER, // Usada en PC
    MUS_HG_VS_ARCEUS,
    MUS_HG_HEAL,
    MUS_HG_LEVEL_UP,
    MUS_HG_OBTAIN_ITEM,
