...
enum Various
{
    ...
    VARIOUS_JUMP_IF_BROMISTA_BLOCKED,
...
#define DMG_1_8_TARGET_HP          1
#define DMG_FULL_ATTACKER_HP       2
...
enum BattleScriptCommands
{
    ...
    BATTLE_CMD_jumpifestado,
    BATTLE_CMD_jumpiftransitorio,
    ...
    BATTLE_CMD_animatransitorio,
    BATTLE_CMD_yesnobox,
    BATTLE_CMD_CancelaAccionesSiNoEntrenador,
    ...
    BATTLE_CMD_RecuperaSaludSegunClima,
    ...
    BATTLE_CMD_PonEspacioRaro,
    BATTLE_CMD_tryimprison,
    BATTLE_CMD_pontransitorio,
    ...
    BATTLE_CMD_jumpifataquefallo,
    BATTLE_CMD_ponresultadoataque,
    BATTLE_CMD_jumpifataquenoafecta,
    BATTLE_CMD_MarcaBajadaPorIntimidacion,
    BATTLE_CMD_MarcaCambioEstadisticaSilencioso,
    BATTLE_CMD_EscribeTextoEstadoAlterado,
    BATTLE_CMD_EscribeTextoPrevencionEstado,
    BATTLE_CMD_MarcaPrevencionPorHabilidadPropia,
    BATTLE_CMD_EscribeTextoCambioClima,
    BATTLE_CMD_EscribeTextoClimaContinua,
    BATTLE_CMD_EscribeTextoDanioClima,
    BATTLE_CMD_EscribeTextoClimaTermina,
    BATTLE_CMD_EscribeTextoLluvia,
    BATTLE_CMD_EscribeTextoNeblina,
    BATTLE_CMD_EscribeTextoSustituto,
    BATTLE_CMD_EscribeTextoReserva,
    BATTLE_CMD_EscribeTextoTragarFalla,
    BATTLE_CMD_EscribeTextoDescanso,
    BATTLE_CMD_EscribeTextoAbsorbeFuego,
    BATTLE_CMD_EscribeTextoBaya,
    BATTLE_CMD_EscribeTextoDrenaje,
    BATTLE_CMD_EscribeTextoDrenadorasTurno,
    BATTLE_CMD_EscribeTextoDrenadoras,
    BATTLE_CMD_EscribeTextoCambioObjeto,
    BATTLE_CMD_EscribeTextoHabilidadEntrada,
    BATTLE_CMD_EscribeTextoHierbaMental,
    BATTLE_CMD_EscribeTextoBarrera,
    BATTLE_CMD_EscribeTextoCuraEquipo,
    BATTLE_CMD_jumpifinsonorizadoatacante,
    BATTLE_CMD_jumpifinsonorizadoaliado,
    BATTLE_CMD_EscribeTextoAtrapado,
    BATTLE_CMD_EscribeTextoDanioTrampa,
    BATTLE_CMD_EscribeTextoBallEscapa,
    BATTLE_CMD_EscribeTextoTrampaPuesta,
    BATTLE_CMD_EscribeTextoEntraPokemon,
    BATTLE_CMD_EscribeTextoDevolverPokemon,
    BATTLE_CMD_settypedhazard,
    BATTLE_CMD_ponmarca,
    BATTLE_CMD_quitamarca,
    BATTLE_CMD_jumpifmarca,
};
